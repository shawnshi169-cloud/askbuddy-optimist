...
export const CLIENT_RPC_WHITELIST = {
  ...
  create_question_v1: RPC_CATALOG.create_question_v1.qualifiedName,
  update_question_v1: RPC_CATALOG.update_question_v1.qualifiedName,
  close_question_v1: RPC_CATALOG.close_question_v1.qualifiedName,
  get_question_detail_v1: RPC_CATALOG.get_question_detail_v1.qualifiedName,
  list_questions_v1: RPC_CATALOG.list_questions_v1.qualifiedName,
  create_answer_v1: RPC_CATALOG.create_answer_v1.qualifiedName,
  delete_answer_v1: RPC_CATALOG.delete_answer_v1.qualifiedName,
  list_question_answers_v1: RPC_CATALOG.list_question_answers_v1.qualifiedName,
  set_answer_helpful_v1: RPC_CATALOG.set_answer_helpful_v1.qualifiedName,
  create_answer_reply_v1: RPC_CATALOG.create_answer_reply_v1.qualifiedName,
  delete_answer_reply_v1: RPC_CATALOG.delete_answer_reply_v1.qualifiedName,
  list_answer_replies_v1: RPC_CATALOG.list_answer_replies_v1.qualifiedName,
  resolve_canonical_topic_v1: RPC_CATALOG.resolve_canonical_topic_v1.qualifiedName,
  get_experience_topics_v1: RPC_CATALOG.get_experience_topics_v1.qualifiedName,
  set_experience_topics_v1: RPC_CATALOG.set_experience_topics_v1.qualifiedName,
